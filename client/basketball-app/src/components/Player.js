  ...
  <div class="col-md-8">
      ...
      <div class="card"> <img class="card-img-top" src="https://i.dlpng.com/static/png/5913661-vinyl-basketball-court-photography-children-backdrops-backdrop-for-basketball-court-background-640_436_preview.png" alt="Card image cap" />
          <div class="card-body little-profile text-center">
              <div class="pro-img"><img src={player.avatar} alt="player" /></div>
              <h3 class="m-b-0">{player.name}</h3>
              <p>{player.bio}</p> <a href="javascript:void(0)" class="m-t-10 waves-effect waves-dark btn btn-primary btn-md btn-rounded" data-abc="true">Challenge</a>
